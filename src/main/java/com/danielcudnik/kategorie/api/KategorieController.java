...
public class KategorieController {
    ...
    private IKategorieService serwisKategorie;

    @Autowired
    public KategorieController(IKategorieService serwisKategorie){
        this.serwisKategorie = serwisKategorie;
    }
    ...
    @ResponseBody
    public ResponseEntity<KategorieDTO> usunKategorie(@PathVariable("nazwa") Long aId){
        try {
            serwisKategorie.usunKategorie(aId);
