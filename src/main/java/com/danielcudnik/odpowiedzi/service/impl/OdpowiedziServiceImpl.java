...
public class OdpowiedziServiceImpl implements IOdpowiedziService {
    ...
    @Autowired
    public OdpowiedziServiceImpl(IOdpowiedziRepository iOdpowiedziRepository, IPytaniaRepository iPytaniaRepository, IKategorieRepository iKategorieRepository){
    ...
    public OdpowiedziDTO zapiszOdpowiedz(OdpowiedziDTO aOdpowiedziDTO) throws MyServerException {
        ...
        if (pPytaniaDTO  == null)  throw new MyServerException("Nie znaleziono pola pytanie", HttpStatus.NOT_FOUND,new HttpHeaders());
        ...
        pOdpowiedziOB.setTechDate(aOdpowiedziDTO.getTechDate());
        aOdpowiedziDTO.setOdpowiedz(aOdpowiedziDTO.getOdpowiedz());
